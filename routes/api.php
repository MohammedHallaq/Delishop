...
Route::group(['prefix'=>'order'],function (){
    ...
    Route::get('getOrderById/{order_id}', [ProductOrderController::class, 'getOrderById'])->name('order.getById')/*->middleware('can:order.get')*/; // Abo Ayman todo: please make it accessable for both, the user and the stor
});
